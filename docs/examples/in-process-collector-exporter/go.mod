module opentelemetry.io/pythonexporter
...
// replace github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter => /usr/local/google/home/aaronabbott/repo/opentelemetry-collector-contrib/exporter/googlecloudexporter
