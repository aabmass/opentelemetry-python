...
class TestShimWithSdk(unittest.TestCase):
    ...
    def test_span_status(self):
        ...
        ok_span: ReadableSpan
        exc_span: ReadableSpan
        ok_span, exc_span = self.mem_exporter.get_finished_spans()
    ...
    def test_otel_sandwich(self):
        ...
        otel_middle: ReadableSpan
        opencensus_inner: ReadableSpan
        (
            opencensus_inner,
            otel_middle,
            opencensus_outer,
        ) = self.mem_exporter.get_finished_spans()
    ...
    def test_opencensus_sandwich(self):
        ...
        self.assertEqual(len(self.mem_exporter.get_finished_spans()), 3)
        otel_outer: ReadableSpan
        opencensus_middle: ReadableSpan
        otel_inner: ReadableSpan
        (
            otel_inner,
            opencensus_middle,
            otel_outer,
