...
def install_shim(
    ...
    # on sampler. We monkeypatch self.tracer with a property to return the shim instance
    # instead. This makes all instances of Tracer (even those already created) use the
    # ShimTracer singleton.
